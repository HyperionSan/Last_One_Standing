...
subroutine SBP_set_coeff_8_4_opt ( nsize, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_8_4_opt

subroutine SBP_set_coeff_up_8_4_opt ( nsize, dir, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_up_8_4_opt

subroutine SBP_set_coeff_up_8 ( nsize, dir, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_up_8
