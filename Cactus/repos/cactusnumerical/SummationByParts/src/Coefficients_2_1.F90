...
subroutine SBP_set_coeff_2_1 ( nsize, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_2_1

subroutine SBP_set_coeff_up_2_1 ( nsize, dir, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_up_2_1

subroutine SBP_set_coeff_up_2 ( nsize, dir, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_up_2
