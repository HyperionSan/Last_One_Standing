...
subroutine SBP_dissipation_4_2_alt (var, ni, nj, nk, bb, gsize, offset, delta, epsilon, rhs)
...
end subroutine SBP_dissipation_4_2_alt

subroutine SBP_dissipation_4_2_delta (var, ni, nj, nk, bb, gsize, offset, &
...
end subroutine SBP_dissipation_4_2_delta
