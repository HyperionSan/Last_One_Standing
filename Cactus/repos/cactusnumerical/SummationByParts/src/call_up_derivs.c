              ...
              const CCTK_INT table_handle )
{
  ...
  int nelements;
  void CCTK_FCALL CCTK_FNAME(SBP_up_deriv_gf_2_1)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
                                       ...
                                       const CCTK_REAL *up,
                                       CCTK_REAL *dvar);
  void CCTK_FCALL CCTK_FNAME(SBP_up_deriv_gf_4_2)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
                                       ...
                                       const CCTK_REAL *up,
                                       CCTK_REAL *dvar);
  void CCTK_FCALL CCTK_FNAME(SBP_up_deriv_gf_6_3_opt)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
                                       ...
                                       const CCTK_REAL *up,
                                       CCTK_REAL *dvar);
  void CCTK_FCALL CCTK_FNAME(SBP_up_deriv_gf_8_4_opt)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
  ...
  if ( CCTK_Equals(norm_type,"Diagonal") ) {
    if ( CCTK_Equals(operator_type,"Minimal Bandwidth") ) {
      switch(loc_order) {
      case 2: {
        CCTK_FNAME(SBP_up_deriv_gf_2_1)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,up,dvar);
        break;
      }
      case 4: {
        CCTK_FNAME(SBP_up_deriv_gf_4_2)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,up,dvar);
        break;
      }
      default:
      ...
      case 6: {
        CCTK_FNAME(SBP_up_deriv_gf_6_3_opt)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,up,dvar);
        break;
      }
      case 8: {
        CCTK_FNAME(SBP_up_deriv_gf_8_4_opt)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,up,dvar);
        break;
      }
      default:
        CCTK_WARN (0, "Unknown stencil specified");
