...
subroutine SBP_deriv_gf_2_1 ( var, ni, nj, nk, dir, bb, gsize, offset, delta, dvar )
...
end subroutine SBP_deriv_gf_2_1

subroutine SBP_up_deriv_gf_2_1 ( var, ni, nj, nk, dir, bb, gsize, delta, up, dvar )
...
end subroutine SBP_up_deriv_gf_2_1
