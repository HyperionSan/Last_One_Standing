...
subroutine SBP_set_coeff_4_2 ( nsize, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_4_2

subroutine SBP_set_coeff_up_4_2 ( nsize, dir, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_up_4_2

subroutine SBP_set_coeff_up_4 ( nsize, dir, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_up_4
