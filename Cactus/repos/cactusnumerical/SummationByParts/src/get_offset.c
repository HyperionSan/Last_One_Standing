 ...
 */
void SBP_get_shiftout ( const CCTK_POINTER_TO_CONST cctkGH_,
                    CCTK_INT *shiftout )
{
 ...
 */
void CCTK_FCALL CCTK_FNAME(SBP_get_shiftout)( const CCTK_POINTER_TO_CONST cctkGH_,
                    CCTK_INT *shiftout )
{
  SBP_get_shiftout ( cctkGH_, shiftout );
}
