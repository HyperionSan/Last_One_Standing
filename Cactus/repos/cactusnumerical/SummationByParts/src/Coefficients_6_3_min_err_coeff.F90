...
subroutine SBP_set_coeff_6_3_opt ( nsize, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_6_3_opt

subroutine SBP_set_coeff_up_6_3_opt ( nsize, dir, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_up_6_3_opt

subroutine SBP_set_coeff_up_6 ( nsize, dir, loc_order, bb, gsize, imin, imax, dd )
...
end subroutine SBP_set_coeff_up_6
