...
subroutine SBP_dissipation_8_4_alt (var, ni, nj, nk, bb, gsize, offset, delta, epsilon, rhs)
...
end subroutine SBP_dissipation_8_4_alt

subroutine SBP_dissipation_8_4_delta (var, ni, nj, nk, bb, gsize, offset, &
...
end subroutine SBP_dissipation_8_4_delta
