               ...
               const CCTK_INT table_handle )
{
  ...
  void CCTK_FCALL CCTK_FNAME(SBP_deriv2_gf_2_1)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
                                       ...
                                       CCTK_REAL *dvar2);
  void CCTK_FCALL CCTK_FNAME(SBP_deriv2_gf_4_2)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
                                       ...
                                       const CCTK_REAL *delta,
                                       CCTK_REAL *dvar2);
  void CCTK_FCALL CCTK_FNAME(SBP_deriv2_gf_4_2_opt)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
                                       ...
                                       const CCTK_REAL *delta,
                                       CCTK_REAL *dvar2);
  void CCTK_FCALL CCTK_FNAME(SBP_deriv2_gf_6_3)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
                                       ...
                                       const CCTK_REAL *delta,
                                       CCTK_REAL *dvar2);
  void CCTK_FCALL CCTK_FNAME(SBP_deriv2_gf_8_4)(const CCTK_REAL *var,
                                       const CCTK_INT *ni,
                                       const CCTK_INT *nj,
                                       const CCTK_INT *nk,
                                       const CCTK_INT *dir,
                                       ...
                                       const CCTK_REAL *delta,
                                       CCTK_REAL *dvar2);
  void CCTK_FCALL CCTK_FNAME(SBP_deriv2_mixed)(const CCTK_POINTER_TO_CONST *cctkGH,
                                       const CCTK_INT *dir1,
                                       const CCTK_INT *dir2,
                                       const CCTK_REAL *var,
                                       const CCTK_INT *ni,
  ...
  if ( dir1 != dir2 ) {
    CCTK_FNAME(SBP_deriv2_mixed)(&cctkGH_,&dir1,&dir2,var,&ni,&nj,&nk,dvar2,&table_handle);
    return;
  } else {
    dir = dir1;
  }
  ...
  if ( CCTK_Equals(norm_type,"Diagonal") ) {
    if ( CCTK_Equals(operator_type,"Minimal Bandwidth") ) {
      switch(loc_order) {
      case 2: {
        CCTK_FNAME(SBP_deriv2_gf_2_1)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,dvar2);
        break;
      }
      case 4: {
        CCTK_FNAME(SBP_deriv2_gf_4_2)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,dvar2);
        break;
      }
      case 6: {
        CCTK_FNAME(SBP_deriv2_gf_6_3)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,dvar2);
        break;
      }
      case 8: {
        CCTK_FNAME(SBP_deriv2_gf_8_4)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,dvar2);
        break;
      }
      default:
      ...
      case 4: {
        CCTK_FNAME(SBP_deriv2_gf_4_2_opt)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,dvar2);
        break;
      }
      case 6: {
        CCTK_FNAME(SBP_deriv2_gf_6_3)(var,&ni,&nj,&nk,&dir,bb,&gsize,&delta,dvar2);
