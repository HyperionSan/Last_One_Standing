...
subroutine SBP_dissipation_2_1_alt (var, ni, nj, nk, bb, gsize, offset, delta, epsilon, rhs)
...
end subroutine SBP_dissipation_2_1_alt

subroutine SBP_dissipation_2_1_delta (var, ni, nj, nk, bb, gsize, offset, &
...
end subroutine SBP_dissipation_2_1_delta
