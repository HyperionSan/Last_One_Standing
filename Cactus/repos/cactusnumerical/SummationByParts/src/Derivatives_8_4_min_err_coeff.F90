...
subroutine SBP_deriv_gf_8_4_opt ( var, ni, nj, nk, dir, bb, gsize, offset, delta, dvar )
...
end subroutine SBP_deriv_gf_8_4_opt

subroutine SBP_up_deriv_gf_8_4_opt ( var, ni, nj, nk, dir, bb, gsize, delta, up, dvar )
...
end subroutine SBP_up_deriv_gf_8_4_opt
