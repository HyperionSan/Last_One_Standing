...
subroutine SBP_dissipation_6_3_alt (var, ni, nj, nk, bb, gsize, offset, delta, epsilon, rhs)
...
end subroutine SBP_dissipation_6_3_alt

subroutine SBP_dissipation_6_3_delta (var, ni, nj, nk, bb, gsize, offset, &
...
end subroutine SBP_dissipation_6_3_delta
