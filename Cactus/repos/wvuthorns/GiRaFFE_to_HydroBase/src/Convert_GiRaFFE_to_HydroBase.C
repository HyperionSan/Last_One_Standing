  ...
  for(int k=0;k<cctk_lsh[2];k++)
    for(int j=0;j<cctk_lsh[1];j++)
      for(int i=0;i<cctk_lsh[0];i++) {
        ...
        vel[CCTK_VECTGFINDEX3D(cctkGH,i,j,k,0)] = (PRIMS[VX] + betax[index])*lapseL_inv;
        vel[CCTK_VECTGFINDEX3D(cctkGH,i,j,k,1)] = (PRIMS[VY] + betay[index])*lapseL_inv;
        vel[CCTK_VECTGFINDEX3D(cctkGH,i,j,k,2)] = (PRIMS[VZ] + betaz[index])*lapseL_inv;
        ...
        Bvec[CCTK_VECTGFINDEX3D(cctkGH,i,j,k,0)] = PRIMS[BX_CENTER];
        Bvec[CCTK_VECTGFINDEX3D(cctkGH,i,j,k,1)] = PRIMS[BY_CENTER];
        Bvec[CCTK_VECTGFINDEX3D(cctkGH,i,j,k,2)] = PRIMS[BZ_CENTER];
