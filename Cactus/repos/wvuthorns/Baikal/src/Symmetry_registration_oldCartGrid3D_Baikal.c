...
#include "Symmetry.h"
/*
 * Register symmetries for NRPy+-generated thorn Baikal
 */
void Symmetry_registration_oldCartGrid3D_Baikal(CCTK_ARGUMENTS) {

  DECLARE_CCTK_ARGUMENTS_Symmetry_registration_oldCartGrid3D_Baikal;
